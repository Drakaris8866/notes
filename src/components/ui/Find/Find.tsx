...
const Find: FC<{ setPosts: any, setPostLoading: any, filter: string, setFilter: any }> = ({setPosts, setPostLoading, filter, setFilter}) => {
    ...
    return <div className={styles.content}>
        <input value={filter} onChange={e => setFilter(e.target.value)} className={styles.find}
               placeholder="Поиск по тегам" type="text"/>
        <svg onClick={() => handleClickClear()} className={styles.icon} xmlns="http://www.w3.org/2000/svg"
